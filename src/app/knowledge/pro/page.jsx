  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // 🔸 Lọc chỉ lấy tài liệu có type là "Chuyên môn"
        const proDocs = result.filter(item => item.type === "Chuyên môn");

        setData(proDocs);
        setFilteredData(proDocs);
      } catch (error) {
      ...
      <div className="flex items-center justify-between gap-4 bg-[#ffdf99] py-3 px-4 rounded-t-2xl border-b-[2px] border-white">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            placeholder="Tìm kiếm tài liệu chuyên môn..."
      ...
      <div className="p-3 flex-1 overflow-auto bg-[#ffffff] rounded-b-2xl">
        {filteredData.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-[60vh] text-gray-600">
            ...
            <p>Không có tài liệu chuyên môn nào.</p>
          </div>
        ) : (
