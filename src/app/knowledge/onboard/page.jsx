  ...
  useEffect(() => {
    async function fetchData() {
      try {
        ...
        // 🔸 Lọc chỉ lấy tài liệu Onboard
        const onboardDocs = result.filter(item => item.type === "Onboard");

        setData(onboardDocs);
        setFilteredData(onboardDocs);
      } catch (error) {
      ...
      <div className="flex items-center justify-between gap-4 bg-[#ffdf99] py-3 px-4 rounded-t-2xl border-b-[2px] border-white">
        ...
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            placeholder="Tìm kiếm tài liệu Onboard..."
      ...
      <div className="p-3 flex-1 overflow-auto bg-[#ffffff] rounded-b-2xl">
        {filteredData.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-[60vh] text-gray-600">
            ...
            />
            <p>Không có tài liệu Onboard nào.</p>
          </div>
        ) : (
